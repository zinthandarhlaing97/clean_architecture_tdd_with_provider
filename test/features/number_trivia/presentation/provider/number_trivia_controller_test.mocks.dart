...
// in clean_architecture_tdd_with_provider/test/features/number_trivia/presentation/provider/number_trivia_controller_test.dart.
...
/// A class which mocks [NumberTriviaProvider].
///
/// See the documentation for Mockito's code generation for more information.
class MockNumberTriviaProvider extends _i1.Mock
    implements _i11.NumberTriviaProvider {
  ...
  @override
  void setupProvider(
          {_i4.GetConcreteNumberTrivia? getConcreteNumberTrivia,
          _i8.GetRandomNumberTrivia? getRandomNumberTrivia,
          _i10.InputConverter? inputConverter}) =>
      super.noSuchMethod(
          Invocation.method(#setupProvider, [], {
